...
<head>
    ...
    <title>About Management - Admin Ican</title>
...
<body class="sb-nav-fixed">
    ...
    <a class="navbar-brand ps-3" href="/dashboard">Manage Skils</a>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <!-- Create New About Button -->
                    <div class="row">
                        <a href="{{ route('admin.about.create') }}" class="btn btn-primary create-btn" role="button">
                            <i class="fas fa-plus-circle"></i> Create New About
                        </a>
                    </div>
                    ...
                    <table class="table table-hover table-striped" id="myTable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if ($about->image)
                                        <img src="{{ asset('storage/' . $about->image) }}" alt="About Image" width="50" height="50" style="object-fit: cover; border-radius: 5px;">
                                    @else
                                        <span>No Image</span>
                                    @endif
                                </td>
                                <td>
                                    <a href="{{ route('admin.about.show', $about) }}" class="btn btn-sm btn-info">Detail</a>
                                    <a href="{{ route('admin.about.edit', $about) }}" class="btn btn-sm btn-warning">Edit</a>
                                    <button type="button" class="btn delete-btn btn-danger btn-sm" data-id="{{ $about->id }}">Delete</button>
                                    <form action="{{ route('admin.about.destroy', $about->id) }}"
                                          id="delete-form-{{ $about->id }}" 
